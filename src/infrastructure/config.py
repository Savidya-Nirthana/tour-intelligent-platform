...
def _get_nested(d: Dict, *keys, default=None):
    """ get nasted dictionary value safely """
    for key in keys:
...
CRAWL_BASE_URL = _get_nested(_PARAMS, "crawling", "base_url", default="https://ceysaid.com/")
...
QDRANT_COLLECTION_NAME = os.getenv("QDRANT_COLLECTION_NAME", "ceysaid")
QDRANT_TIMEOUT=30



DATA_DIR  = _PROJECT_ROOT / _get_nested(_PARAMS, "paths", "data_dir", default="data")
VECTOR_DIR  = _PROJECT_ROOT / _get_nested(_PARAMS, "paths", "vector_dir", default="data/vector_store")
MARKDOWN_DIR  = _PROJECT_ROOT / _get_nested(_PARAMS, "paths", "markdown_dir", default="data/ceysaid_markdown")
